...
type Country struct {
	...
	IsoCode2         string `orm:"column(iso_code_2);size(2)"`
	IsoCode3         string `orm:"column(iso_code_3);size(3)"`
	AddressFormat    string `orm:"column(address_format)"`
	PostcodeRequired int8   `orm:"column(postcode_required)"`
